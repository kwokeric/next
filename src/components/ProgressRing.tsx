...
export function ProgressRing({
  ...
  // The pop animation should only play for a checkmark that just appeared —
  // not for a task that was already done when this row mounted (e.g. on
  // page load, or after collapsing/reopening a section).
  ...
  return (
    ...
    >
      {isComplete ? (
        <div
          className={justCompleted ? `${styles.filled} ${styles.filledPop}` : styles.filled}
          aria-hidden="true"
        >
